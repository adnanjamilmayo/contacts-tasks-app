      ...
      <div className="container mx-auto max-w-7xl px-4 py-8">
        ...
        <header className="mb-10">
          <div className="mb-3 flex items-center gap-3">
            <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 p-3 shadow-lg">
              <TrendingUp className="h-8 w-8 text-white" aria-hidden="true" />
            </div>
            <div>
              <h1 className="bg-gradient-to-r from-slate-900 via-blue-800 to-slate-900 bg-clip-text text-5xl font-extrabold text-transparent dark:from-white dark:via-blue-200 dark:to-white">
                Contacts & Tasks
              </h1>
        ...
        <main id="main-content">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              {error && (
                <div
                  role="alert"
                  aria-live="assertive"
                  className="animate-in slide-in-from-top-5 rounded-xl border-2 border-red-200 bg-gradient-to-r from-red-50 to-red-50/50 p-6 shadow-lg dark:border-red-900 dark:from-red-950 dark:to-red-950/50"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <button
                      ...
                      className="rounded-lg bg-red-600 px-4 py-2 text-white transition-all hover:bg-red-700 hover:shadow-md active:scale-95 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
              ...
              {/* Loading State */}
              {loading && (
                <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-slate-200 bg-white py-24 dark:border-slate-700 dark:bg-slate-800">
                  <Loader2
              ...
              {!loading && !error && sortedContacts.length === 0 && (
                <div className="rounded-2xl border-2 border-slate-200 bg-white p-16 text-center dark:border-slate-700 dark:bg-slate-800">
                  <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-slate-100 p-4 dark:bg-slate-700">
                    <User
              ...
              {!loading && !error && totalPages > 1 && (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-3 font-bold text-white shadow-lg">
            ...
            <div className="space-y-6">
              {selectedContact ? (
                <>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-3 font-semibold text-white shadow-lg transition-all hover:from-blue-700 hover:to-blue-800 hover:shadow-xl active:scale-95 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  ...
                  {/* Task Summary */}
                  <div className="rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100/50 p-6 dark:border-blue-900 dark:from-blue-950/50 dark:to-blue-900/30">
                ...
                <div className="rounded-2xl border-2 border-slate-200 bg-white p-20 text-center dark:border-slate-700 dark:bg-slate-800">
                  <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-slate-100 p-4 dark:bg-slate-700">
                    <Circle
                      className="h-12 w-12 text-slate-400"
                      aria-hidden="true"
          ...
          {/* Footer Stats */}
          {!loading && !error && sortedContacts.length > 0 && (
            <footer className="mt-10 border-t-2 border-slate-200 pt-8 dark:border-slate-800">
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-6" aria-label="Statistics">

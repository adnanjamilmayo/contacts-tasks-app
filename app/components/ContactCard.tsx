...
export function ContactCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "transform cursor-pointer rounded-2xl border-2 p-5 transition-all duration-200 hover:scale-[1.02] hover:shadow-xl active:scale-[0.98]",
        isSelected
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex flex-1 items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h3 className="mb-1 truncate text-lg font-bold text-slate-900 dark:text-white">
              {contact.name}
            </h3>
